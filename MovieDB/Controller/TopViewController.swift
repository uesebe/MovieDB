...
class TopViewController: UIViewController, UITableViewDataSource, UITableViewDelegate {
    ...
    final let urlTop  = URL(string: "https://api.themoviedb.org/3/movie/top_rated?api_key=34738023d27013e6d1b995443764da44")
    ...
    func downloadJson() {
        guard let downloadURL = urlTop else {return}
    ...
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        guard let cell = tableView.dequeueReusableCell(withIdentifier: "MovieCellTop", for: indexPath) as? MovieCell else { return UITableViewCell() }
